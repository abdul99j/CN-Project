...
public class IPv4 extends BasePacket{
    ...
    public String getSourceAddress() {
        return values.get("Source IP").toString();
    }

    @Override
    public String getDestinationAddress() {
        return values.get("Destination IP").toString();
    }

    @Override
    public ArrayList<String> getValuesNames() {
        ArrayList<String> value_names=new ArrayList<>();
        value_names.addAll(Arrays.asList(valueNames));
        return value_names;
    }

    @Override
    public Object[] getValues() {
        Object[] value = new Object[valueNames.length];
